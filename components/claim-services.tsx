		...
		<section>
			<div className="max-w-6xl mx-auto px-4 sm:px-6">
				<div>
					...
					{/* CTA box */}
					<div className="relative bg-blue-500 rounded-xl xs:py-4 md:py-14 xs:px-4 md:px-8 xs:my-2 md:my-6 shadow-2xl overflow-hidden" data-aos="zoom-y-out">
						...
						<div className="flex justify-center items-center">
							<div className="sm:w-3/4 md:w-3/5 flex flex-row flex-nowrap items-center">
								...
								<p className="xs:text-xl md:text-4xl text-white font-bold xs:mb-1 md:mb-2 xs:ml-4 md:ml-8">Подать заявку можно здесь</p>
							</div>
							<div className="xs:w-2/5 md:w-3/5 flex sm:flex-col md:flex-row justify-end items-end xs:gap-2 md:gap-4">
